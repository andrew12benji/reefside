...
import { getSettings } from "@/lib/game/settings";
      ...
      <div className="htp-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="htp-section">
          ...
          <div className="htp-row">
            <span className="htp-key">ARROWS / WASD</span>
            <span className="htp-desc">Swim through the reef</span>
          </div>
          <div className="htp-row">
            <span className="htp-key">SPACE / W</span>
            <span className="htp-desc">Swim upward</span>
          </div>
          <div className="htp-row">
            <span className="htp-key">E</span>
            <span className="htp-desc">Activate your Guardian ability</span>
          </div>
          <div className="htp-row">
            <span className="htp-key">P</span>
            <span className="htp-desc">Pause game</span>
          </div>
          <div className="htp-row">
            <span className="htp-key">M</span>
            <span className="htp-desc">Toggle sound</span>
          </div>
        </div>
        ...
        <div className="htp-section">
          ...
          <div className="htp-desc" style={{ lineHeight: "2" }}>
            The reef has 10 zones. Each zone has a health % shown at the top of
            the screen.
            <br />
            <br />
            VIBRANT CORAL = Healthy zone &nbsp; | &nbsp; WHITE/GREY = Bleached
            zone
            <br />
            <br />
            Defeat enemies in a zone to restore its health. Climate events
            damage all zones.
          </div>
        </div>
        ...
        <div className="htp-section">
          ...
          <div className="htp-row">
            <span className="htp-key" style={{ background: "#00E8D8" }}>
              SCIENTIST
            </span>
            <span className="htp-desc">
              SCAN: Reveals hidden pearls + boosts restoration for 10s
            </span>
          </div>
          <div className="htp-row">
            <span
              className="htp-key"
              style={{ background: "#66AA44", color: "#fff" }}
            >
              RANGER
            </span>
            <span className="htp-desc">
              RESILIENCE: Halts zone damage + triples restoration for 15s
            </span>
          </div>
          <div className="htp-row">
            <span
              className="htp-key"
              style={{ background: "#F8B800", color: "#020C1A" }}
            >
              FISHER
            </span>
            <span className="htp-desc">
              BALANCE: Stuns all enemies on screen for 8s
            </span>
          </div>
          <div className="htp-row">
            <span
              className="htp-key"
              style={{ background: "#CC44FF", color: "#fff" }}
            >
              ADVOCATE
            </span>
            <span className="htp-desc">
              CAMPAIGN: +15% Support Meter instantly
            </span>
          </div>
        </div>

        <div className="htp-goal">
          MISSION: Protect 30% of the reef (3+ zones above 60% health) by the
          year 2030
        </div>
  ...
  return (
    <div data-testid="title-screen" className="title-screen">
      ...
      <div className="rf-logo-area">
        ...
        <div className="rf-logo" data-testid="reefside-logo">
          REEFSIDE
        </div>
        <div className="rf-tagline">
          PROTECT THE GREAT BARRIER REEF - 30x30 BY 2030
        </div>
  ...
  return (
    <div data-testid="pause-screen" className="pause-overlay">
      ...
      <div className="pause-controls">
        <div>
          GUARDIAN: {GUARDIAN_LABELS[guardian] || guardian.toUpperCase()}
        </div>
...
export default function UnderwaterGame() {
  const [screen, setScreen] = useState<"title" | "hub" | "game" | "end">(
    "title"
  );
